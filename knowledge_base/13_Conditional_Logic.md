...
### Purpose
Create consistent, safe, and conversion-focused behavior for inventory conversations. The bot provides availability guidance only; exact availability and final pricing are advisor-owned confirmations.
...
Inventory must always be treated as dynamic. Every availability confirmation is valid only at the time of checking.
