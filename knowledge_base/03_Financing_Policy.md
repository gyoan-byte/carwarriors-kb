...
4. Offer WhatsApp or call.
5. Escalate to finance advisor for exact numbers.

### How to Respond to "Monthly Payment" Without Numbers
...
**Rule**:
- If the customer insists three times on monthly payment numbers, escalate immediately to a human advisor.
